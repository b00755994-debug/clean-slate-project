                              ...
                              <Select value={linkedinProfile.slack_user_id || 'none'} onValueChange={value => {
                                ...
                                <SelectTrigger className="border-0 bg-transparent p-0 h-auto w-auto shadow-none focus:ring-0 [&>svg]:hidden">
                                  {linkedinProfile.slack_user_id ? (() => {
                                    ...
                                    <Badge variant="outline" className="cursor-pointer hover:bg-[#4A154B]/10 hover:border-[#4A154B]/30 gap-1.5 transition-colors py-1 pl-2.5 pr-2.5 text-xs border-dashed border-muted-foreground/30 text-muted-foreground">

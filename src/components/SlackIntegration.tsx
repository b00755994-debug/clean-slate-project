              ...
              <div className="w-64 bg-[#3F0E40] text-white p-4 flex flex-col border-r border-white/10 font-lato">
                ...
                <div className="flex-1 space-y-1 overflow-y-auto">
                  ...
                  <div className="mb-4">
                    ...
                    <button className="w-full text-left px-2 py-1.5 rounded flex items-center gap-2 text-white/70 hover:bg-white/10">
                      <div className="w-4 h-4 rounded flex-shrink-0 bg-purple-500 flex items-center justify-center text-[8px] font-bold">JC</div>
                  ...
                  <div>
                    ...
                    <button className="w-full text-left px-2 py-1.5 rounded flex items-center gap-2 text-white/70 hover:bg-white/10">
                      ...
                      <Badge variant="secondary" className="ml-auto text-[8px] px-1.5 py-0.5 h-4 bg-green-500/20 text-green-400 border border-green-500/30 font-medium">INSTALLED</Badge>
                    </button>
                  </div>
                </div>
